...
0000000000400fce <func4>:
  ...
  400fd4:	29 f0                	sub    %esi,%eax              #0xe
  400fd6:	89 c1                	mov    %eax,%ecx              #0xe
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx
  400fdb:	01 c8                	add    %ecx,%eax
  400fdd:	d1 f8                	sar    %eax                   #0x7
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx     #0x7
...
#输入的六个数是无重复的,在1到6之间（包括1和6）
  ...
  401121:	76 05                	jbe    401128 <phase_6+0x34>     #if eax <=5 goto
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d                #r12d++
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>     #if r12d == 6 goto
  401132:	44 89 e3             	mov    %r12d,%ebx                 #ebx = r12d
  401135:	48 63 c3             	movslq %ebx,%rax                  #rax = ebx
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax         #eax = num[rax]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51>      #if eax != num[i]  goto 
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                  #ebx++
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>      #if ebx <=5 goto
  40114d:	49 83 c5 04          	add    $0x4,%r13                  #r13+4
  401151:	eb c1                	jmp    401114 <phase_6+0x20>      #goto

#替换为7的补码
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi            #rsi = &num[6]
  401158:	4c 89 f0             	mov    %r14,%rax                  #rax=rsp
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx
  401160:	89 ca                	mov    %ecx,%edx                  #edx = 7
  401162:	2b 10                	sub    (%rax),%edx                #edx = edx - num[i]
  401164:	89 10                	mov    %edx,(%rax)                #num[i]=edx
  401166:	48 83 c0 04          	add    $0x4,%rax                  #i++
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>      #if rax != rsi goto loop
...
#按 num[i] (代表链表深度),存储链表
  ...
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx             #edx 链表地址
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)     #存储链表地址
  40118d:	48 83 c6 04          	add    $0x4,%rsi                  #rsi += 4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx         #ecx = num[i]
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>      #if ecx<= 1 goto loop
...
#重新排序链表
  ...
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)             #指向下个节点
...
#排序后的链表是倒序的
  ...
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>      #前一个节点的值要大于后一个节点值
...
00000000004015c4 <phase_defused>:
  ...
  4015df:	75 5e                	jne    40163f <phase_defused+0x7b> # 40163f
